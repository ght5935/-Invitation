<template>
    <div class="map">
        ...
        <map class="content" id="map" longitude="114.6292050000" latitude="33.5782910000" :markers="markers" scale="18" @tap="toNav">
        </map>
        <div class="call">
...
export default {
  ...
  data () {
    return {
      ...
      markers: [{
        ...
        id: 0,
        latitude: 33.5782910000,
        longitude: 114.6292050000,
        width: 50,
        height: 50
      }]
    }
  ...
  methods: {
    ...
    linkHe () {
      wx.makePhoneCall({
        phoneNumber: '18516232575'
      })
    },

    linkShe () {
      wx.makePhoneCall({
        phoneNumber: '15839453232'
      })
    }
  }
}
