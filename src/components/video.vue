<template>
  <div class="section">
    <video
      id="myVideo"
      src="https://cdn.aimeike.tv/thumbnail/preview/preview_sdwvG_thumb.mp4?auth_key=1548339233-0-0-74a4eedfa4c2fbaae448bd61ac5105b4"
      :danmu-list="danmuList"
      enable-danmu
      danmu-btn
      controls
      poster="https://7765-wedding-1258511601.tcb.qcloud.la/assest/y5.jpg"
    ></video>
    <div class="btn-area">
  ...
  methods: {
    ...
    getMessageList() {
      ...
      message.get().then(res => {
        let data = res.data && res.data ? res.data.reverse() : [];
        let arr = [];
        if (data.length > 0) {
